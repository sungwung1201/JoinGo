...
class RobotController(Node):
    ...
    def init_firebase(self):
        ...
        cred_path = os.path.join(package_path, "resource", "rokey-d-2-4c32a-firebase-adminsdk-fbsvc-8e6d802500.json")
    ...
    def fetch_positions_from_db(self, line_id="1"):
        """Firebase DB에서 특정 라인의 마커 좌표와 할당 번호를 가져옵니다."""
        try:
            # 제공된 구조 이미지 기반: /linestatus/1/markers 경로 참조
    ...
    def robot_control(self):
        ...
        if target_obj == "all_check":
            ...
            success = self.fetch_positions_from_db(line_id="1")
